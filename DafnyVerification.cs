// Dafny program DafnyVerification.dfy compiled into C#
...
// Dafny 2.3.0.10506
// Command Line Options: DafnyVerification.dfy DafnyVerification.cs
// DafnyVerification.dfy
...
namespace _0_DafnyVerification_Compile {

  public partial class SortingService {
    public void BubbleSort(BigInteger[] a)
    {
      var _this = this;
    TAIL_CALL_START: ;
      BigInteger _82_i;
      _82_i = (new BigInteger((a).Length)) - (new BigInteger(1));
      while ((_82_i) > (new BigInteger(0))) {
        BigInteger _83_j;
        _83_j = new BigInteger(0);
        while ((_83_j) < (_82_i)) {
          if (((a)[(int)(_83_j)]) > ((a)[(int)((_83_j) + (new BigInteger(1)))])) {
            var _index0 = (_83_j) + (new BigInteger(1));
            BigInteger _rhs0 = (a)[(int)((_83_j) + (new BigInteger(1)))];
            BigInteger _rhs1 = (a)[(int)(_83_j)];
            (a)[(int)((_83_j))] = _rhs0;
            (a)[(int)(_index0)] = _rhs1;
          }
          _83_j = (_83_j) + (new BigInteger(1));
        }
        _82_i = (_82_i) - (new BigInteger(1));
      }
    }
  }

  public partial class BinarySearchService {
    public void BinarySearch(BigInteger[] a, BigInteger key, out BigInteger r)
    {
      var _this = this;
    TAIL_CALL_START: ;
      r = BigInteger.Zero;
      ...
      BigInteger _rhs3 = new BigInteger((a).Length);
      _84_lo = _rhs2;
      _85_hi = _rhs3;
      while ((_84_lo) < (_85_hi)) {
        BigInteger _86_mid;
        _86_mid = Dafny.Helpers.EuclideanDivision((_84_lo) + (_85_hi), new BigInteger(2));
        if ((key) < ((a)[(int)(_86_mid)])) {
          _85_hi = _86_mid;
        } else if (((a)[(int)(_86_mid)]) < (key)) {
          _84_lo = (_86_mid) + (new BigInteger(1));
        } else {
          r = _86_mid;
          return;
        }
      }
      r = (new BigInteger(0)) - (new BigInteger(1));
      return;
    }
  }

} // end of namespace _0_DafnyVerification_Compile
namespace _module {
